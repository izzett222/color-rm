...
const roadmapData: RoadmapItem[] = [
  ...
  },
  {
    ...
    description:
      "Path to becoming an AI or ML engineer, from math to deployment.",
  ...
  },
  {
    ...
    description:
      "Complete guide for native and cross-platform mobile app development.",
    category: "Mobile",
    rating: 4.5,
    votes: 167,
    status: "in-progress",
...
const RoadmapSearch: React.FC = () => {
  ...
  const suggestedTags = useMemo(() => {
    ...
    const relevantItems = roadmapData.filter(
      (item) =>
